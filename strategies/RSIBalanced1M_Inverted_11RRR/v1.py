...
class RSIBalanced1M_Inverted_11RRR(Strategy):
    """
    Author: MCP Client
    Description: INVERTED version of RSIBalanced1M with 1:1 RRR (fixed 17.5 pips).
    """
    ...
    def risk_model(self, df: pd.DataFrame, vars: dict[str, pd.Series]) -> dict[str, pd.Series]:
        # Fixed 1:1 RRR at 17.5 pips (average of 10 and 25)
        distance = 17.5
