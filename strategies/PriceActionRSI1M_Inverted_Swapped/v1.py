...
class PriceActionRSI1M_Inverted_Swapped(Strategy):
    """
    Author: MCP Client
    Description: INVERTED version of PriceActionRSI1M with SWAPPED distances.
    """
    ...
    def risk_model(self, df: pd.DataFrame, vars: dict[str, pd.Series]) -> dict[str, pd.Series]:
        # SWAPPED: Original SL=15, TP=35 become inverted SL=35, TP=15
        original_sl_distance = 15.0
        original_tp_distance = 35.0
